...
public partial class TownPanel : UIWindow
{
    ...
    {
        if (Town is not null) updateUI(); // keep UI up to date with changing town stats // can't we only update when a stat updates or smth idk like on tick
    }
